...
//		LogUtil.log(TAG+" onCreateView-----------");
	...
	public void onClick(View v) {
		...
		if(v == btnStartRealtimeData){
			...
			getPillowHelper().stopRealTimeData(1000, new IDataCallback<Void>() {
				@Override
			...
			getPillowHelper().stopCollection(1000, new IDataCallback<Void>() {
				@Override
				public void onDataCallback(final CallbackData<Void> cd) {
					// TODO Auto-generated method stub
					mActivity.runOnUiThread(new Runnable() {
...
//								tvCollectStatus.setText(R.string.working_state_not);
			...
			getPillowHelper().getCollectionStatus(1000, new IDataCallback<Byte>() {
				@Override
			...
			getPillowHelper().startCollection(1000, new IDataCallback<Void>() {
				@Override
				public void onDataCallback(final CallbackData<Void> cd) {
					// TODO Auto-generated method stub
					mActivity.runOnUiThread(new Runnable() {
